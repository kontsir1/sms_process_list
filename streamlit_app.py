...
def load_data(file):
    """Load the uploaded file into a DataFrame, considering the pipe delimiter and treating numbers as strings."""
...
def remove_duplicates(df):
    ...
    return df.drop_duplicates(subset="MSISDN", keep="first")
...
uploaded_file = st.sidebar.file_uploader("Choose a file (TXT or CSV)")
...
if uploaded_file is not None:
    try:
        ...
        df = drop_customer_id(remove_duplicates(validate_msisdn(df)))
